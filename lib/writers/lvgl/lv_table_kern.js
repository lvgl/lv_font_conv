...
class LvKern extends Kern {
  ...
  to_lv_format0() {
    ...
    let kern_pair_ids = kern_pairs.map(pair =>
...
{
${u.long_dump(kern_class_mapping(left_classes))}
};

/*Map glyph_ids to kern right classes*/
static uint8_t kern_right_class_mapping[] =
{
${u.long_dump(kern_class_mapping(right_classes))}
};

/*Kern values between classes*/
static uint8_t kern_class_values =
{
${u.long_dump(kern_class_values())}
};
