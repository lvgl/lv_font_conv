...
class Head {
  ...
  toBin() {
    ...
    // TODO: uncomment when vars available
    //buf.writeUInt16LE(f.typoAscent, O_TYPO_ASCENT);
    //buf.writeInt16LE(f.typoDescent, O_TYPO_DESCENT);
    //buf.writeUInt16LE(f.typoLineGapt, O_TYPO_LINE_GAP);
