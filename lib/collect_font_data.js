...
module.exports = function collect_font_data(args, createCanvas) {
  ...
  for (let dst_code of all_dst_charcodes) {
    ...
    // kerning is not supported by fontkit
    let kerning = {};
  ...
  // opentype
  ascent = Math.round(first_font.ascender * args.size / first_font.unitsPerEm);
  descent = Math.round(first_font.descender * args.size / first_font.unitsPerEm);
